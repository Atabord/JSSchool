...
eval("__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n\nvar initBookShelfApp = __webpack_require__(/*! ./showBooks */ \"./src/js/showBooks.js\");\n\nvar initEvents = __webpack_require__(/*! ./events */ \"./src/js/events.js\"); // This function inits the whole application calling initBooks and initEvents\n\n\nfunction initApp() {\n  initBookShelfApp();\n  initEvents();\n} // init the app when the page has loaded.\n\n\nwindow.addEventListener('load', initApp);\n\n//# sourceURL=webpack:///./src/js/index.js?");
